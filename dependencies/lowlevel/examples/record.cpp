...
int FMOD_Main()
{
    ...
    */
    ...
    unsigned int actualLatency = desiredLatency;                        /* Latency measured once playback begins (smoothened for jitter) */
        ...
        */
        ...
        if (channel)
        {
            ...
            */
            ...
            actualLatency = (unsigned int)((0.97f * actualLatency) + (0.03f * latency));
